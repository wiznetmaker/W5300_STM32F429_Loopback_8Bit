...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define LOOPBACK_SOCKET 0
#define LOOPBACK_PORT   5000
...
uint8_t dest_ip[4] = {192, 168, 11, 20};
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
    //loopback_tcps(LOOPBACK_SOCKET, g_eth_buf, LOOPBACK_PORT);
    loopback_tcpc(LOOPBACK_SOCKET, g_eth_buf, dest_ip, LOOPBACK_PORT);
  }
  /* USER CODE END 3 */
}
